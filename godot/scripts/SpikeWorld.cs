...
public partial class SpikeWorld : Node2D
{
    ...
    private void SavePortScreenshot()
    {
        ...
        var mapPath = Path.Combine(destDir, "godot-port-no-umbra-map.png");
        ...
        var seamClose = Path.Combine(destDir, "godot-port-no-umbra-close.png");
        ...
        var seamElbow = Path.Combine(destDir, "godot-port-no-umbra-elbow.png");
        ...
        crop.SavePng(Path.Combine(destDir, "godot-port-no-umbra-overview.png"));
    }
